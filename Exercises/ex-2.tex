...
\begin{enumerate}
  ...
  \item Consider the fully entanglment state $\ket{\Omega} = \sum_{x}{\ket{x,x}}$ over the system $\mathcal{H}_{A} \otimes \mathcal{H}_{B}$. Compute the conditional enteropy $S(A|B)$.
