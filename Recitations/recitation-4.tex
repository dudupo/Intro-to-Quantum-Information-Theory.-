...
\begin{frame}
  ...
  \begin{equation*}
    \begin{split}
      \Tr_{[1,2]}M\rho^{\otimes 3} &= \left( \left( 1 - \frac{p}{2} \right)^3 + 3 \left( 1 - \frac{p}{2} \right)^{2} \right) \ket{0}\bra{0} +  \\ 
      &+ \left( 3\left( 1 - \frac{p}{2} \right) + \left( \frac{p}{2} \right)^{3} \right) \ket{1}\bra{1}\\
    \end{split}
  \end{equation*}
\end{frame}
\end{document}
