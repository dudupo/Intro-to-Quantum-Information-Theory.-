...
\end{equation*}
\begin{claim}
The protocol's success probability is greater than $\frac{1}{2}p^{2}$. In particular, if $p > \frac{1}{2}$, then the success probability is greater than $\frac{1}{4}$.
\end{claim}
\begin{proof}
...
\begin{equation*}
  ...
  \end{split}
\end{equation*}
And the normalization factor is obtained by summing up the weight of each non-canceled term. The red, numbers stand for the states which after been projected are transofromd into $\EPR$. 
\begin{equation*}
  \begin{split}
