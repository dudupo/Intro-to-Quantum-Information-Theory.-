...
\begin{enumerate}
  \item $\ket{0}$ if $f(s)_{2i}f(s)_{2i+1} = 00$ 
  \item $\ket{1}$ if $f(s)_{2i}f(s)_{2i+1} = 01$ 
  \item $\ket{+}$ if $f(s)_{2i}f(s)_{2i+1} = 10$ 
  \item $\ket{-}$ if $f(s)_{2i}f(s)_{2i+1} = 11$ 
\end{enumerate}
...
Now the verification of banknote is going as followes, the bank asks for the coin $\left( f(s), \ket{\psi_s} \right)$ then, by looking at the table it restore $s$.
