...
\begin{proof}
  ...
  Consider fixed purifications $\ket{\psi}_{RAB}$ and $\ket{\phi}_{RAB}$ of $\rho_{AB}$ and $\sigma_{AB}$, respectively, which also purify $\rho_A$ and $\sigma_A$. Namely the purifications over $AB$-subsystem is a subset of the purifications over the $A$-subsestem. Therefore: 
  \begin{equation*}
    \begin{split}
