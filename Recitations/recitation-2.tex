...
The verification of a banknote is as follows: the bank asks for the coin $\left( f(s), \ket{\psi_s} \right)$. Then, by looking at the table, it restores $s$ and measures the $i$th qubit in the basis according to $s_{2i}$ and compares the results to $s_{2i+1}$.
